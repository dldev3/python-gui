...
# db.insert("4GB DDR4 Ram", "John", "Microcenter","160")
# db.insert("Samsung IPS screen", "Jane", "TechWorld","330")
# db.insert("Metalic Keyboard", "Paul", "Microcenter","80")
# db.insert("Wireless Mouse", "Peter", "NanoTek","200")
